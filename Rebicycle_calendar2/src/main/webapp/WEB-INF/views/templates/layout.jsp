...
<title><tiles:insertAttribute name="title" ignore="true"/></title>
 <!-- Bootstrap Core CSS -->
	...
	<link rel='stylesheet prefetch' href='http://cdnjs.cloudflare.com/ajax/libs/fullcalendar/2.6.0/fullcalendar.min.css'>
...
<div id="skipnav"><a href="#maincontent">Skip to main content</a></div>
    ...
    <script src="${pageContext.request.contextPath}/resources/vendor/jquery/moment.min.js"></script>

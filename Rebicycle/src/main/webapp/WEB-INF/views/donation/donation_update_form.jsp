            ...
            <div class="panel-body" > 
				<form  class="form-horizontal" enctype="multipart/form-data" method="post" action="${pageContext.request.contextPath }/donation/donation_update.do">
				    ...
				    <div id="div_id_title" class="form-group required"> 
				        ...
				        <div class="controls col-md-8 "> 
				            <input class="input-md textinput textInput form-control" id="id_title" name="title" style="margin-bottom: 10px" type="text" readonly="readonly" value="${requestScope.donationVO.title}"/>
				        </div>
				    </div>
				    ...
				    <div id="div_id_detail" class="form-group required">
				         ...
				         <div class="controls col-md-8 ">
				            <input class="input-md textinput textInput form-control" id="id_detail" name="detail" value="${requestScope.donationVO.detail}"style="margin-bottom: 10px" type="text" required="required"/>
				        </div>
				    </div>
